...
def checkStockSecurity():
    ...
    message = EmailMessage("Productos A Reponer","Productos Cerca de Stock de Seguridad",
                           settings.EMAIL_HOST_USER,["nferrari3444@gmail.com", "victoria.bonetti@filsa.com.uy"])
