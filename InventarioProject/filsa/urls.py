...
from .views import index, inboundView, getProducts, getProduct, getProductsNames, transferView, filterProducts, transferReceptionView, outboundDeliveryView, outboundOrderView, finishTask, inboundReceptionView, TaskListView, StockListView, StockHistoryView
