# Generated by Django 5.0.1 on 2024-03-16 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='filsa.product')),
            ],
        ),
        migrations.AddField(
            model_name='tasks',
            name='warehouse',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='filsa.warehousesproduct'),
        ),
        migrations.CreateModel(
            name='DiffProducts',
            fields=[
                ...
                ('warehouse', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='filsa.warehousesproduct')),
            ],
            options={
